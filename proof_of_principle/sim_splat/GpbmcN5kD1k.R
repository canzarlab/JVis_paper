...
dat <- logcounts(sim)
dat[1:16,1:16] <- 400 # add few outliers (0.4%)

dataname <- "GpbmcN5kD1k"
...
params2 <- setParam(params2, "batchCells", 5000)
params2 <- setParam(params2, "nGenes", 1000)
n_groups <- 5
deprob2 <- rep(0.02, n_groups)

de.facLoc2 <- c(1.0, 0.8, 1.0, 1.0, 0.8)
